...
namespace PhxDev.mmhmmStreamDeckPlugin.PluginApp
{
    class Program
    {
        ...
        static void RunPlugin(Options options)
        {
            ...
            connection.OnKeyUp += (sender, args) =>
            {
                ...
                switch (args.Event.Action)
                {
                    case "phxdev.mmhmmstreamdeckplugin.nextslide":
                        Log("Next Slide");
                        UI.NextSlide();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.previousslide":
                        Log("Previous Slide");
                        UI.PreviousSlide();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.resetcamera":
                        Log("Reset Camera");
                        UI.ResetCamera();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.togglecamera":
                        Log("Toggle Camera");
                        UI.ToggleCamera();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.increasepresentersize":
                        Log("Increase Presenter Size");
                        UI.IncreasePresenterSize();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.decreasepresentersize":
                        Log("Decrease Presenter Size");
                        UI.DecreasePresenterSize();
                        break;
                    case "phxdev.mmhmmstreamdeckplugin.toggleaway":
                        Log("Toggle Away");
                        UI.ToggleAway();
                        break;
                }
